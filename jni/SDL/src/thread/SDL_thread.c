...
SDL_RunThread(void *data)
{
	...
	#ifdef __ANDROID__    
		__android_log_print(ANDROID_LOG_INFO, "SDL_thread.c", "enter SDL_RunThread ok %d",  gettid() );
	#endif
	...
	#ifdef __ANDROID__    
		__android_log_print(ANDROID_LOG_INFO, "SDL_thread.c", "SDL_SYS_SetupThread ok  %d",  gettid() );
	#endif
	...
	#ifdef __ANDROID__    
		__android_log_print(ANDROID_LOG_INFO, "SDL_thread.c", "SDL_ThreadID ok %d",  gettid() );
	#endif
	...
	#ifdef __ANDROID__    
		__android_log_print(ANDROID_LOG_INFO, "SDL_thread.c", "SDL_SemPost ok %d",  gettid() );
	#endif


	#ifdef __ANDROID__   
		if(!userfunc)
		__android_log_print(ANDROID_LOG_INFO, "SDL_thread.c", "userfunc NULL %d",  gettid() );
	#endif
