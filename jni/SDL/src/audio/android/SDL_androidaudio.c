...
AndroidAUD_OpenDevice(_THIS, const char *devname, int iscapture)
{
	...
	__android_log_print(ANDROID_LOG_ERROR, "SDL", "SDL_CalculateAudioSpec START");
	
    SDL_CalculateAudioSpec(&this->spec);
	
	__android_log_print(ANDROID_LOG_ERROR, "SDL", "SDL_CalculateAudioSpec END OK");
	...
	__android_log_print(ANDROID_LOG_ERROR, "SDL", "AndroidAUD_OpenDevice OK");
