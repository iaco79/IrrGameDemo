...
extern "C" jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
	...
	__android_log_print(ANDROID_LOG_ERROR, "SDL", "JNI_OnLoad");
...
extern "C" void SDL_Android_Init_AudioThread(JNIEnv* mEnv, jclass cls)
{
	...
	__android_log_print(ANDROID_LOG_INFO, "SDL", "SDL_Android_Init_AudioThread() finished!");	
...
extern "C" void SDL_Android_Init(JNIEnv* mEnv, jclass cls)
{
	...
	*/
	...
	if(!midAudioInit)
		__android_log_print(ANDROID_LOG_WARN, "SDL", "callback midAudioInit not found ");
		
	if(!midAudioWriteShortBuffer)
		__android_log_print(ANDROID_LOG_WARN, "SDL", "callback midAudioWriteShortBuffer not found ");

	if(!midAudioWriteByteBuffer)
		__android_log_print(ANDROID_LOG_WARN, "SDL", "callback midAudioWriteByteBuffer not found ");

	if(!midAudioQuit)
		__android_log_print(ANDROID_LOG_WARN, "SDL", "callback midAudioQuit not found ");
...
static void Android_JNI_ThreadDestroyed(void* value) {
    ...
    if (env != NULL) {
		...
		__android_log_print(ANDROID_LOG_ERROR, "SDL", "SDL_ANDROID detaching thread %d",  gettid() );
...
extern "C" void Android_JNI_EndThread()
{
	...
	{
		__android_log_print(ANDROID_LOG_ERROR, "SDL", "SDL_ANDROID detaching thread jenv null %d",  gettid() );	
	}
...
int Android_JNI_SetupThread(void) {
	...
	__android_log_print(ANDROID_LOG_ERROR, "SDL", "SDL_ANDROID attched thread %d",  gettid() );
...
extern "C" int Android_JNI_OpenAudioDevice(int sampleRate, int is16Bit, int channelCount, int desiredBufferFrames)
{
	...
	__android_log_print(ANDROID_LOG_WARN, "SDL", "Android_JNI_OpenAudioDevice OK");
