...
namespace irr
{
    namespace video
    {
		...
		#else
			static const char* vertexShaderFile   = "/mnt/sdcard/GameDemo/COGLES2Renderer2D.vsh";
			static const char* fragmentShaderFile = "/mnt/sdcard/GameDemo/COGLES2Renderer2D.fsh";
		#endif
